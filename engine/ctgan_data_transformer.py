...
class UnpackbitsEncoder(BaseTransformer):
    """UnpackbitsEncoder for id.

    This transformer unpacks a single vector into a binary-valued output array.
    """
    ...
    def _fit(self, data):
        ...
        Get the pandas `dummies` which will be used later on for UnpackbitsEncoding.
