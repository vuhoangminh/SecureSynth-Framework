...
# ---------------------------------------------------------------------------
def main():
    D = get_dataset("biobank_patient_dead")
    df_hold = D.data_test
    df_real = D.data_train

    folder, filename_fake = (
        "biobank_patient_dead-tabddpm-lv_2-bs_4096-epochs_30000-df_9-dm_9-dl_8-nl_4-lr_1.81e-03-model_mlp-moment_4-losscorcorr_3.27e+02-lossdis_3.35e-14-condvec_1",
        "fake_30000",
    )

    # folder, filename_fake = (
    #     "biobank_patient_dead-tabddpm-lv_0-bs_4096-epochs_5000-dm_682-dh_525-df_0.2-ds_0.2-nl_4-lr_4.68e-04-model_resnet-condvec_1",
    #     "fake_05000",
    # )

    folder, filename_fake = (
        "biobank_patient_dead-ctgan-lv_2-bs_7500-epochs_1300-ed_32-dd_128-gd_128-glr_5.67e-05-moment_2-losscorcorr_2.97e+03-lossdis_3.15e-07-condvec_0",
        "fake_01300",
    )

    folder, filename_fake = (
        "biobank_patient_dead-tvae-lv_2-bs_27000-epochs_1400-ed_32-cd_256-dd_256-l2_7.68e-06-moment_1-losscorcorr_4.54e+02-lossdis_6.76e-08-condvec_1",
        "fake_01400",
    )
