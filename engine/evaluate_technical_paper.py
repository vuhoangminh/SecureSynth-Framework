...
def compute_ml_metrics_all_ml_methods(
    ...
    for method, function in dict_method.items():
        if ml_params_setting["mode"] == "best":
            ...
            if "biobank_phase3_cancer" in folder:
                fmin = get_best_set_params_imbalanced(
...
def main():
    ...
    parser.add_argument(
        ...
        default="/media/minhvu/My Passport1/github/biobank-anonymization-visualization/database/gan",
        help="dir logs",
    )
    parser.add_argument(
        "-a",
