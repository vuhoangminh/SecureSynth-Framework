...
def init_search_space(args):
    ...
    if "biobank_phase3" in args.dataset:
        batch_size_choices = list(range(100, 1000 + 1, 100))
        batch_size_choices_ctab = list(range(10, 40 + 1, 10))  # OOM
        epochs_choices = list(range(100, 1001, 100))
